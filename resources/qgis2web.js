...
map.getView().fit([3527515.886363, -3309188.920084, 3637355.118030, -3250962.504830], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Population by Izigodi</h2>';
        return titleElement;
    })(),
...
var searchLayer = new SearchLayer({
    layer: lyr_Izigodi_Population_1,
    colName: 'Name',
    zoom: 10,
    collapsed: true,
    map: map,
